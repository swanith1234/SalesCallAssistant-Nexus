...
async def process_transcription(payload: TranscriptIn):
    ...
    # try:
    #     # ✅ NEW: Track which user owns this room
    #     if payload.user_email and payload.room_id not in STORE_USERS:
    #         STORE_USERS[payload.room_id] = payload.user_email
    #         logging.info(f"✅ Room {payload.room_id} assigned to {payload.user_email}")
